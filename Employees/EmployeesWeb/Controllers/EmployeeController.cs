...
namespace EmployeesWeb.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public IActionResult Edit(int? id)
        {
            ...
            //var EmployeesFromDb = _db.Employees.FirstOrDefault(u => u.EmployeeID == id);
        ...
        {
            #region
            //if (obje.employeename == obje.department)
            //{
        ...
        public IActionResult Delete(int? id)
		{
            ...
            //var employeesFromDb = _db.Employees.Find(id);
            var employeesFromDb = _db.Employees.FirstOrDefault(u => u.EmployeeID == id);
            //var categoryFromDbSingle = _db.Employees.SingleOrDefault(u => u.Id == id);
